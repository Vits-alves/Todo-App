    ...
    render() {
        return (
            <div>
                ...
                <TodoForm 
                    description={this.state.description} //estado
                    handleChange={this.handleChange} //escutando onchange do input
                    handleAdd={this.handleAdd} //adicionar
                    handleSearch={this.handleSearch} //consultar
                    handleClear={this.handleClear}  />  
                <TodoList 
                    list={this.state.list}
                    handleMarkAsDone={this.handleMarkAsDone} //marcar como feita
